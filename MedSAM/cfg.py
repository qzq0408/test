...
def parse_args():    
    ...
    parser.add_argument('-mod', type=str, default='sam_adpt', help='mod type: sam_adpt, sam_adpt_evp, sam_lora, seg, cls, val_ad')
    ...
    parser.add_argument('-fourier_blocks', type=int, default=4, help='number of shallow ViT blocks using FourierBandSelector; -1 enables all blocks')
    parser.add_argument('-fourier_bands', type=int, default=3, help='radial frequency bands (low/mid/high) in FourierBandSelector')
    parser.add_argument('-boundary_loss_weight', type=float, default=0.1, help='weight for Fourier edge-boundary alignment loss')
